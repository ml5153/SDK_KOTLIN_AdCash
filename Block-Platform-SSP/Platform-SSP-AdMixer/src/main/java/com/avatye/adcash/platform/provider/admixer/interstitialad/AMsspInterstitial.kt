package com.avatye.adcash.platform.provider.admixer.interstitialad
...
import com.avatye.adcash.platform.provider.admixer.interstitialad.loader.AMsspInterstitialBoxLoader
import com.avatye.adcash.platform.provider.admixer.interstitialad.loader.AMsspInterstitialLoader
import com.avatye.adcash.platform.provider.admixer.interstitialad.loader.AMsspInterstitialLoaderBase
import com.avatye.adcash.platform.provider.admixer.interstitialad.loader.AMsspInterstitialLoaderCallback
import com.avatye.adcash.platform.provider.admixer.interstitialad.loader.AMsspInterstitialNativeLoader
import com.avatye.adcash.platform.provider.admixer.interstitialad.loader.AMsspInterstitialRewardVideoLoader
import com.avatye.adcash.platform.provider.admixer.interstitialad.loader.AMsspInterstitialVideoLoader
...
class AMsspInterstitial(
...
) : AdsviserInterstitial(), AMsspInterstitialLoaderCallback {

    private val sourceName = "AMsspInterstitial"
    ...
    override fun onFailed(error: AdsviserError) {
        ...
        weakActivity.isAvailable {
            if (error.isBlocked) {
                ...
                callback.onFailed(
                    error = AMsspErrorUnit.of(
                        errorUnit = AMsspErrorUnit.BLOCKED
                    )
                )
            } else {
                currentLoader?.onDestroy()
    ...
    private fun loaderFactory(property: AdsviserInterstitialProperty): AMsspInterstitialLoaderBase? {
        if (weakActivity.get() != null && weakActivity.get()?.isAlive == true) {
            return when (property.unitType) {
                AdsviserInterstitialUnit.INTERSTITIAL -> AMsspInterstitialLoader(
                    activity = ownerActivity,
                    placementAppKey = placementAppKey,
                    placementId = property.placementID,
                    callback = this@AMsspInterstitial
                )

                AdsviserInterstitialUnit.INTERSTITIAL_NATIVE -> AMsspInterstitialNativeLoader(
                    activity = ownerActivity,
                    placementAppKey = placementAppKey,
                    placementId = property.placementID,
                    callback = this@AMsspInterstitial
                ...
                AdsviserInterstitialUnit.INTERSTITIAL_BOX -> AMsspInterstitialBoxLoader(
                    activity = ownerActivity,
                    placementAppKey = placementAppKey,
                    placementId = property.placementID,
                    callback = this@AMsspInterstitial
                ...
                AdsviserInterstitialUnit.INTERSTITIAL_VIDEO -> AMsspInterstitialVideoLoader(
                    activity = ownerActivity,
                    placementAppKey = placementAppKey,
                    placementId = property.placementID,
                ...
                AdsviserInterstitialUnit.INTERSTITIAL_REWARD_VIDEO -> AMsspInterstitialRewardVideoLoader(
                    activity = ownerActivity,
                    placementAppKey = placementAppKey,
                    placementId = property.placementID,
                    mediationExtra = mediationExtra,
