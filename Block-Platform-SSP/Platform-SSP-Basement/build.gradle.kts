...
android {
    namespace = "com.avatye.adcash.platform.provider.basement"
...
//    implementation(project(":Block-Platform-SSP:Platform-SSP-AdPopcorn"))
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Platform.sspBasement
