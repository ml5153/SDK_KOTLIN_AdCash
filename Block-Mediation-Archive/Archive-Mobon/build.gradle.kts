...
android {
    namespace = "com.avatye.adcash.mediation.archive.mobon"
...
dependencies {
    ...
    api("io.github.mobon:mobonSDK:${Version.Advertisement.mobon}") {
        isTransitive = true
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveMobon
