...
android {
    namespace = "com.avatye.adcash.mediation.archive.cauly"
...
dependencies {
    ...
    api("com.fsn.cauly:cauly-sdk:${Version.Advertisement.cauly}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveCauly
