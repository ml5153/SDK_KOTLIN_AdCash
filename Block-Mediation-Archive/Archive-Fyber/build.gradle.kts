...
android {
    namespace = "com.avatye.adcash.mediation.archive.fyber"
...
dependencies {
    ...
    api("com.fyber:marketplace-sdk:${Version.Advertisement.fyber}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveFyber
