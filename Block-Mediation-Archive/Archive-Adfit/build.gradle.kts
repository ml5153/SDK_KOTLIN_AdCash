...
android {
    namespace = "com.avatye.adcash.mediation.archive.adfit"
...
dependencies {
    ...
    api("com.kakao.adfit:ads-base:${Version.Advertisement.adfit}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveAdfit
