...
android {
    namespace = "com.avatye.adcash.mediation.archive.unity"
...
dependencies {
    ...
    api("com.unity3d.ads:unity-ads:${Version.Advertisement.unityads}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveUnity
