...
android {
    namespace = "com.avatye.adcash.mediation.archive.pangle"
...
dependencies {
    ...
    api("com.pangle.global:pag-sdk:${Version.Advertisement.pangle}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archivePangle
