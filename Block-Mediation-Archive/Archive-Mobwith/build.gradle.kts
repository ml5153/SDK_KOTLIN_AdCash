...
android {
    namespace = "com.avatye.adcash.mediation.archive.mobwith"
...
dependencies {
    ...
    api("io.github.mobon:mobwithSDK:${Version.Advertisement.mobwith}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveMobwith
