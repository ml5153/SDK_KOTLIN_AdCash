...
android {
    namespace = "com.avatye.adcash.mediation.archive.applovin"
...
dependencies {
    ...
    api("com.applovin:applovin-sdk:${Version.Advertisement.applovin}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveAppLovin
