...
android {
    namespace = "com.avatye.adcash.mediation.archive.vungle"
...
dependencies {
    ...
    api("com.vungle:vungle-ads:${Version.Advertisement.vungle}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveVungle
