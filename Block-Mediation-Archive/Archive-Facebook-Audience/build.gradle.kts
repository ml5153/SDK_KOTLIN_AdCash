...
android {
    namespace = "com.avatye.adcash.mediation.archive.fan"
...
dependencies {
    ...
    api("com.facebook.android:audience-network-sdk:${Version.Advertisement.facebook}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveFacebookAudience
