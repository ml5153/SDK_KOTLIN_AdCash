...
android {
    namespace = "com.avatye.adcash.mediation.archive.admob"
...
dependencies {
    ...
    api("com.google.android.gms:play-services-ads:${Version.Advertisement.admob}")
}
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Mediation.archiveAdMob
