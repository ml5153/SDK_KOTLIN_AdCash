...
dependencies {
    ...
    api(project(":Block-Platform-SSP:Platform-SSP-AdHouse"))
    api(project(":Block-Platform-SSP:Platform-SSP-AdPopcorn"))
    //api(project(":Block-Platform-SSP:Platform-SSP-AdMixer"))
    api(project(":Block-Platform-SSP:Platform-SSP-MezzoMedia"))
    api(project(":Block-Platform-SSP:Platform-SSP-DoYouAd"))
}
afterEvaluate {
    publishing {
        repositories {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.productAdcash
