...
android {
    namespace = "com.avatye.adcash.platform.library"
...
dependencies {
    ...
    implementation("androidx.core:core-ktx:${Version.Core.ktx}")
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:${Version.Core.coroutines}")
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = Publish.ArtifactIds.Platform.librarySupport
